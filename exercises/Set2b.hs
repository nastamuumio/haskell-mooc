...
binomial n 0 = 1
binomial 0 k = if k>0 then 0 else binomial 0 0
...
leftpad str 0 = str
leftpad str n = if length str == n then str else " " ++ leftpad str (n-1)
...
biggestPrimeAtMost 0 = 5704
biggestPrimeAtMost 1 = 5704
